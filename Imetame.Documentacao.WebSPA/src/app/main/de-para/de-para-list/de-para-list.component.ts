...
@Component({
    selector: "de-para-list",
    templateUrl: "./de-para-list.component.html",
    styleUrls: ["./de-para-list.component.scss"],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class DeParaListComponent implements OnInit, OnDestroy, AfterViewInit {
    private _unsubscribeAll: Subject<any>;

    displayedColumns = ["credenciadora", "de", "para", "buttons"];
    ...
    ngOnInit() {
        this.titleService.setTitle("De Para - Imetame");
