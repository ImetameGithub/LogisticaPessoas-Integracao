...
@Injectable()
export class ProcessamentoService implements Resolve<any> {
    routeParams: any;
    ...
    add(item) {
        return new Promise((resolve, reject) => {
            this.dataService
                .post(this.apiUrl + "Processamento/", item)
                .subscribe((response: any) => {
    ...
    save(item) {
        return new Promise((resolve, reject) => {
            this.dataService
                .put(this.apiUrl + "Processamento/", item)
                .subscribe((response: any) => {
                    resolve(response);
    ...
    delete(item: any): Promise<any> {
        return new Promise((resolve, reject) => {
            this.dataService
                .delete(this.apiUrl + "Processamento/" + item.id)
                .subscribe((response) => {
