...
namespace Imetame.Documentacao.Infra.Data.Migrations
{
    ...
    [Migration("20240905123754_update_tbl_documento_new_columns")]
    partial class update_tbl_documento_new_columns
    {
            ...
            modelBuilder.Entity("Imetame.Documentacao.Domain.Entities.ColaboradorxPedido", b =>
                {
                    ...
                    b.Property<DateTime>("CXP_DTINCLUSAO")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 5, 9, 37, 54, 215, DateTimeKind.Local).AddTicks(2387));
            ...
            modelBuilder.Entity("Imetame.Documentacao.Domain.Entities.Documento", b =>
                {
                    ...
                    b.Property<string>("DescricaoCredenciadora")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");
                    ...
                    b.Property<string>("IdDocCredenciadora")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Imetame.Documentacao.Domain.Entities.DocumentoxColaborador", b =>
                {
                    ...
                    b.Property<DateTime>("DXC_DTENVIO")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 5, 9, 37, 54, 214, DateTimeKind.Local).AddTicks(7966));
