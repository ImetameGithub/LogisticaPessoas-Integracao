...
namespace Imetame.Documentacao.Infra.Data.Context
{
	public class ApplicationDbContext : DbContext
	{
		...
		public DbSet<Domain.Entities.DocumentoProtheus> DocumentoProtheus { get; set; }
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Domain.Entities.DocumentoProtheus>(new DocumentoProtheusMap().Configure);
